...
const controllers = require("../../../controllers/user/otp_pendaftaran/index");
const helper = require("../../../helpers/user/otp_pendaftaran/index");
...
router.post(
  "/Users/Otp_pendaftaran/server_side",
  [verify_session],
...
router.post(
  "/Users/Otp_pendaftaran/delete",
  [verify_token],
  body("id")
    .notEmpty()
    .withMessage("ID Otp Pendaftaran Tidak Boleh Kosong")
    .trim()
