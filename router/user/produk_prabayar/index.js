...
const controllers = require("../../../controllers/user/produk_prabayar/index");
const helper = require("../../../helpers/user/produk_prabayar/index");
...
router.post(
  ...
  body("kategori")
    .notEmpty()
    .withMessage("Kategori ID Tidak Boleh Kosong")
    .trim()
...
router.post(
  "/Users/Produk_prabayar/delete_produk_prabayar",
  [verify_token],
  body("id")
    .notEmpty()
    ...
    .trim()
    .custom(helper.check_produk_id),
  controllers.delete_produk_prabayar
);
