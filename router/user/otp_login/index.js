...
const controllers = require("../../../controllers/user/otp_login/index");
const helper = require("../../../helpers/user/otp_login/index");
...
router.post(
  "/Users/Otp_login/server_side",
  [verify_session],
  controllers.server_side
);

router.post(
  "/Users/Otp_login/delete",
  [verify_token],
  body("id")
    .notEmpty()
    .withMessage("ID Otp Login Tidak Boleh Kosong")
    .trim()
