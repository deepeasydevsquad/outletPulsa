...
/**
 * Fungsi untuk menghapus data riwayat fee agen
 **/
  ...
  if (!errors.isEmpty()) {
    ...
    if (await model_cud.response()) {
      res.status(200).json({
        error: false,
        error_msg:
          "Proses Penghapusan Data Riwayat Fee Agen berhasil dilakukan",
      });
    } else {
      res.status(400).json({
        error: true,
        error_msg: "Proses Penghapusan Data Riwayat Fee Agen gagal dilakukan.",
      });
    }
  }
};
