...
/**
 * Fungsi untuk menghapus data Validasi Seller Digiflaz
 **/
  ...
  if (!errors.isEmpty()) {
    ...
    if (await model_cud.response()) {
      res.status(200).json({
        error: false,
        error_msg:
          "Proses Penghapusan Data Validasi Seller Digiflaz berhasil dilakukan",
      });
    } else {
      res.status(400).json({
        error: true,
        error_msg:
          "Proses Penghapusan Data  Validasi Seller Digiflaz gagal dilakukan.",
      });
    }
  }
};
